...
<title>FootBallTogether - 투표하기</title>
...
$(function(){
	...
	//투표한사람
	var a = ${fn:length(vVo.vrVoList)};
	$('#voteNum').text(a);

	//회원 총 명수
	var b = ${fn:length(tVo.tmvList)};
	$('#totalNum').text(b);

	// 참석 투표수
	var c = ${voteResultCount};
	$('#attNum').text(c);
	//불참 투표수
	var c = ${voteResultCount};
	$('#noAttNum').text(a-c);
									...
									<div class="form-group row"
											...
											<div class="row" style="margin-top: 20px">
												...
												<div class="col-md-4">
													<div id="" class="form-control"
														style="background-color: rgb(2, 253, 137, 0.5)">
														<input type="checkbox" name="voteCheck" value="0">&nbsp;&nbsp;불참
													</div>
												</div>
											</div>
										</div>
										<div class="col-lg-6">
											<div class="row" style="margin-top: 20px">
												<div class="col-md-4">
													<div id="" class="form-control"
														style="background-color: rgb(254, 1, 91, 0.5)">
														<input type="checkbox" name="voteCheck" value="1">&nbsp;&nbsp;참석
													</div>
												</div>
												<div class="col-md-4"></div>
												<div class="col-md-4"></div>
