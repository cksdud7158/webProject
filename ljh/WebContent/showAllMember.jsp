...
<div class="clearfix"></div>
  ...
  <div class="col-lg-9">
		<div class="card">
		  <div class="card-body">
			<h5 class="card-title" align="center" style="font-size:20px">All Members in ${tVo.teamName}</h5>
            ...
            <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col" style="font-size: 15px;">정신력</th>
                ...
                <tbody>
                  <c:forEach items="${allMember}" var="member" varStatus="status">
                  	<tr>
                  	  ...
                  	  <td>${member.height} / ${member.weight}</td>
                  	  <td>${member.mental}</td>
                  	  <td>${member.pass}</td>
                  	  <td>${member.speed}</td>
                  	  <td>${member.dribble}</td>
                  	  <td>${member.defence}</td>
                  	  <td>${member.physical}</td>
                  </c:forEach>
                </tbody>
              </table>
            </div>
