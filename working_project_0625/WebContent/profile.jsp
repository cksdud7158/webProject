 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="profile.jsp">
          <i class="zmdi zmdi-folder-star"></i> <span>내정보</span>
        </a>
      </li>
      <li>
        <a href="userSchedule.jsp">
          <i class="zmdi zmdi-calendar-check"></i> <span>나의 일정</span>
        </a>
      </li>
       <li>
        <a href="userSetting.jsp">
          <i class="icon-settings mr-2"></i> <span>설정</span>
        </a>
      </li>
      </ul>
   </div>
