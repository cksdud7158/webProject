	...
	<div id="wrapper">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<form action="makeVote.do" method="post">
								...
								<div class="tab-content p-3">
									<div class="tab-pane active" id="matchInfo">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" name="stadiumName"
													id="stadiumName"
													class="form-control form-control-rounded" value="${tVo.sVo.stadiumName}">
											</div>
										</div>								<div class="form-group row">
											<label class="col-lg-3 col-form-label form-control-label">경기장 위치</label>
											<div class="col-lg-9">
												<input type="text" name="stadiumName"
													id="stadiumName"
													class="form-control form-control-rounded" value="${tVo.sVo.stadiumAddr}">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label form-control-label">경기타입</label>
											<div class="col-lg-9">
												<input type="text" name="stadiumType"
													id="stadiumType"
													class="form-control form-control-rounded" value="${tVo.sVo.stadiumType}">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<textarea rows="10" cols="10" name="contents" id="contents"
													class="form-control"
													placeholder="내용을 기입해주세요."></textarea>
											</div>
										</div>
					...
					<div class="form-group row" style="text-align: right;">
						...
						<div class="col-lg-9">
							<input type="reset" class="btn btn-secondary" value="다시작성하기">
							<button type="submit" id="submitBtn" class="btn btn-light px-5">
								<i class="icon-lock"></i>투표만들기
							</button>
						</div>
					</div>
				</form>
