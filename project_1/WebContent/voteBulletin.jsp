	...
	<div id="wrapper">
		...
		<div id="sidebar-wrapper" data-simplebar=""
			...
			<div class="brand-logo">
				<a href="index.html"> <img src="ours/c" class="logo-icon"
					alt="logo icon">
				</a>
			</div>
			<ul class="sidebar-menu do-nicescrol">
				...
				<li><a href="showAllMember.jsp"> <i
						class="zmdi zmdi-accounts"></i> <span>멤버보기</span>
				</a></li>
				<li><a href="teamSchedule.jsp"> <i
						class="zmdi zmdi-calendar-check"></i> <span>일정</span>
				</a></li>
				<li><a href="matchHistory.jsp"> <i
						class="zmdi zmdi-file-text"></i> <span>전적조회</span>
				</a></li>
				<li><a href="vote.jsp"> <i class="zmdi zmdi-check-square"></i>
						<span>투표</span>
				</a></li>
				<li><a href="findMatch.jsp"> <i
						class="zmdi zmdi-search-for"></i> <span>매치찾기</span>
				</a></li>
				<li><a href="teamInfo.jsp"> <i
						class="zmdi zmdi-folder-star"></i> <span>팀 페이지</span>
				</a></li>
				<li><a href="request.jsp" target="_blank"> <i
						class="zmdi zmdi-account-circle"></i> <span>가입신청</span>
				</a></li>
				<li><a href="teamSetting.jsp" target="_blank"> <i
							...
							<div class="tab-content p-3">
								<div class="tab-pane active" id="matchInfo">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<div name="stadiumName" id="stadiumName" class="form-control">${vVo.writer}
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<div name="stadiumName" id="stadiumName" class="form-control">${tVo.sVo.stadiumName}
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label">경기장
											주소</label>
										<div class="col-lg-9">
											<div name="stadiumAddr" id="stadiumAddr" class="form-control">${tVo.sVo.stadiumAddr}
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<div name="stadiumType" id="stadiumType" class="form-control">${tVo.sVo.stadiumType}
											</div>
										</div>
									</div>

									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label">마감시간</label>
										<div class="col-lg-9">
											<div name="dueDate" id="dueDate" class="form-control">${vVo.dueDate}
											</div>
										</div>
									</div>
									<br>
									<div class="form-group row"
										...
										<div class="col-lg-6">
											<div class="row" style="margin-top: 20px">
												...
												<div class="col-md-4"></div>
												<div class="col-md-4">
													<div id="" class="form-control"><input type="checkbox" name = "voteCheck" value="0">&nbsp;&nbsp;불참</div>
												</div>
											</div>
										</div>
										<div class="col-lg-6">
											<div class="row" style="margin-top: 20px">
												<div class="col-md-4">
													<div id="" class="form-control"><input type="checkbox" name = "voteCheck" value="1">&nbsp;&nbsp;참석</div>
												</div>
												<div class="col-md-4"></div>
												<div class="col-md-4"></div>
											</div>
