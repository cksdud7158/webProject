	...
	<div id="wrapper">
		...
		<div id="sidebar-wrapper" data-simplebar=""
			...
			<div class="brand-logo">
				<a href="index.html"> <img src="ours/img/logo.png"
					class="logo-icon" alt="logo icon">
				</a>
			</div>
			<ul class="sidebar-menu do-nicescrol">
				<li class="sidebar-header"><b style="font-size: large">Menu</b></li>
				<li style="margin-left: 50px; margin-bottom: 5px;">반갑습니다. <span>${uVo.userId}</span>님
				</li>
		...
		<div class="content-wrapper">
			<!-- 내용을  쓰시면 됩니다. -->
			<div class="jumbotron">
				<h1>${uVo.userId} 회원가입을 축하드립니다.</h1>
				<p>FootBall Together와 함께 즐겁고 건강한 축구 즐기시길 바랍니다.</p>
			</div>
